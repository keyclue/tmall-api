...
/*
    ...
    {label: '상태', value:'status'},{label:'SKU', value:'orders_order_0_outer_sku_id'},
    ...
    {label:'mobile phone',value:'receiver_mobile'}];
*/
      var xls = json2xls(flattenOrders,{ 
        fields: ['created','title','buyer_nick','pay_time','receiver_name','receiver_mobile','receiver_zip','receiver_state','receiver_city','receiver_district','receiver_address','orders_order_0_outer_sku_id','payment','num','orders_order_0_title']
      });
